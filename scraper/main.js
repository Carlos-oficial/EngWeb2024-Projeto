...
uri = (id) => `https://www.uminho.pt/PT/ensino/oferta-educativa/Cursos-Conferentes-a-Grau/_layouts/15/UMinho.PortalUM.UI/Pages/CatalogoCursoDetail.aspx?itemId=${id}&catId=15`
...
for (let index = 4847; index <= 5212; index++) {
    axios.get(uri(index))
        .then((r) => {
            ...
            const main_table = document.getElementById("ctl00_PlaceHolderMain_ctlPlanosCurso_pnlPlano")
            i = 1
            list = []
            while (1) {
